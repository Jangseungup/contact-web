...
const EditBox = ({ setIsEdit }: { setIsEdit: (isEdit: boolean) => void }) => {
    ...
    return (
        <Box>
            ...
            <EditItem title="전화번호" keyString="phoneNumber" value={editedContact.phoneNumber} onChange={handleChange} />
            ...
            <EditItem title="설명" keyString="description" value={editedContact.description} onChange={handleChange} />
            <ButtonBox>
                <ConfirmButton onClick={editedContact.id ? handleModify : handleSave}>확인</ConfirmButton>
